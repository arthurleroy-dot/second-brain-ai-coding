...
Global IT spending will exceed $6.15 trillion in 2026 ([Gartner, 2026](https://www.gartner.com/en/newsroom/press-releases/2026-02-03-gartner-forecasts-worldwide-it-spending-to-grow-10-point-8-percent-in-2026-totaling-6-point-15-trillion-dollars)). AI-related investment will cross $2.53 trillion ([softwarestrategiesblog, 2026](https://softwarestrategiesblog.com/2026/02/16/gartner-forecasts-agentic-ai-overtakes-chatbot-spending-2027)). Agentic AI is growing at 119% CAGR ([softwarestrategiesblog.com, 2026](https://softwarestrategiesblog.com/2026/02/16/gartner-forecasts-agentic-ai-overtakes-chatbot-spending-2027)). Per-seat SaaS is structurally broken. Junior developer demand has collapsed by 40% where AI is deployed seriously ([secondtalent, 2026](https://secondtalent.com/resources/how-ai-is-changing-engineering-talent-demand)). And 72% of CIOs report they are barely breaking even on AI investments.
...
Gartner forecasts worldwide IT spending will reach $6.15 trillion in 2026 — a 10.8% increase year-over-year ([Gartner, 2026](https://www.gartner.com/en/newsroom/press-releases/2026-02-03-gartner-forecasts-worldwide-it-spending-to-grow-10-point-8-percent-in-2026-totaling-6-point-15-trillion-dollars)). AI-related spending alone will hit $2.53 trillion, with agentic AI growing at 119% CAGR ([softwarestrategiesblog, 2026](https://softwarestrategiesblog.com/2026/02/16/gartner-forecasts-agentic-ai-overtakes-chatbot-spending-2027)). The five largest technology companies plan to deploy $562 billion in AI capex in 2026 alone ([rbcwealthmanagement.com](https://www.rbcwealthmanagement.com/en-us/insights/big-techs-ai-expansion-from-investment-to-scalable-returns)).

NVIDIA’s data center revenue reached $51.2 billion in a single quarter — a 66% year-over-year increase — driven by AI infrastructure demand ([cbinsights.com](https://www.cbinsights.com/research/report/big-tech-ai-future-growth-charts)).

Q1 2026 shattered venture funding records: $300 billion deployed globally, with 80% ($242 billion) flowing to AI companies ([news.crunchbase.com](https://news.crunchbase.com/venture/record-breaking-funding-ai-global-q1-2026)). OpenAI reached a $500 billion valuation. Anthropic hit $380 billion after a $30 billion Series G ([news.crunchbase.com](https://news.crunchbase.com/venture/foundational-ai-startup-funding-doubled-openai-anthropic-xai-q1-2026)). The M&A wave is equally significant: $1.22 trillion in Q1 2026 — the most active start to a year since 2021, with 60 deals exceeding $10 billion ([markets.financialcontent.com](https://markets.financialcontent.com/stocks/article/marketminute-2026-4-3-ai-supercycle-propels-q1-2026-m-and-a-to-record-12-trillion-amid-geopolitical-storms)).

### The Death of Per-Seat SaaS

The most consequential structural shift in software is the collapse of per-seat pricing.

Companies using pure seat-based models fell from 21% to 15% in one year, while hybrid consumption models grew from 27% to 41% ([softwareequity.com](https://softwareequity.com/research/annual-saas-report)). IDC forecasts that by 2028, per-seat pricing will be structurally obsolete — with 70% of software vendors migrated to consumption-, outcome-, or capability-based models ([IDC](https://idc.com/resource-center/blog/is-saas-dead-rethinking-the-future-of-software-in-the-age-of-ai)).

The “SaaSocalypse” of early 2026 erased $285 billion in software company value ([windsordrake.com](https://windsordrake.com/saas-valuation-multiples)). Median EV/Revenue multiples collapsed from 18.6x in 2021 to approximately 6x today ([windsordrake.com](https://windsordrake.com/saas-valuation-multiples)). For the first time in history, the software sector traded at a discount to the S&P 500 ([saastr.com](https://www.saastr.com/saas-markets-have-crashed-in-2026-but-is-private-credit-the-even-bigger-risk)).

Gartner predicts 35% of point SaaS tools — survey tools, basic CRM, simple task managers — will be replaced by AI agents by 2030 ([Gartner, October 2025](https://www.gartner.com/en/newsroom/press-releases/2025-10-21-gartner-unveils-top-predictions-for-it-organizations-and-users-in-2026-and-beyond)). The tools most at risk are those without a defensible data layer, strong network effects, or vertical specificity. Vertical AI, by contrast, grew 400% year-over-year and tripled to $3.5 billion in 2025 ([Menlo Ventures](https://menlovc.com/perspective/2025-the-state-of-generative-ai-in-the-enterprise)). Bessemer Venture Partners forecasts vertical AI market cap may exceed legacy vertical SaaS by a factor of ten ([Menlo Ventures](https://menlovc.com/perspective/2025-the-state-of-generative-ai-in-the-enterprise)).

### The Consulting and IT Services Reckoning

McKinsey estimates that 57% of US working hours can be automated with existing technology ([Outsource Accelerator / McKinsey](https://news.outsourceaccelerator.com/?p=80615)). Gartner goes further: by 2030, 100% of IT work will involve AI — 75% with AI augmentation and 25% by AI autonomously (Gartner, October 2025).

At the company level, the signal is already visible. KPMG cut entry-level hiring by 29%, Deloitte by 18%, and EY by 11% ([Fortune](https://fortune.com/2026/01/22/deloitte-job-title-change-ai-reshapes-big-4-accounting-consulting-firms)). EPAM’s stock dropped 16–21% on earnings despite $600M+ AI revenue guidance, because investors fear AI deflation: faster delivery means fewer billable hours (investing.com). Jefferies reduced price targets on Indian IT companies by up to 33% ([CNBC Inside India](https://www.cnbc.com/2026/02/26/cnbc-inside-india-newsletter-ai-hit-software-firms-india-it.html)).
...
| Year | Milestone |
| --- | --- |
| 2026 | IT spend exceeds $6T. 40% of enterprise apps include AI agents (Gartner, August 2025). SaaS trades at a discount to the S&P 500. |
| 2028 | Per-seat pricing becomes obsolete. AI agents intermediate $15T in B2B purchases ([Digital Commerce 360](https://www.digitalcommerce360.com/2025/11/28/gartner-ai-agents-15-trillion-in-b2b-purchases-by-2028)). 90% of enterprise engineers use AI assistants. |
| 2030 | 35% of point SaaS is replaced. 70% of routine coding is automated. All IT work involves AI (Gartner, October 2025). |
| 2035 | Agentic AI accounts for 30% of enterprise software revenue ($450B+). AI augmentation contributes 40%+ productivity gains across advanced economies. |

## Part 2. How Software Development Changes

### AI Is Already Writing Half the Code

84% of developers use or plan to use AI tools. 92% of US developers had adopted some form of AI coding by early 2026 ([secondtalent.com](https://secondtalent.com/resources/how-ai-is-changing-engineering-talent-demand)). GitHub Copilot has 20 million users and is deployed in 90% of Fortune 100 companies ([quantumrun.com](https://quantumrun.com/consulting/github-copilot-statistics)). Cursor reached $500 million ARR and a $9.9 billion valuation ([digidai.github.io](https://digidai.github.io/2026/03/14/cursor-vs-github-copilot-ai-coding-tools-deep-comparison)).

AI now generates 46% of code in files where Copilot is active — rising to 61% for Java ([quantumrun.com](https://quantumrun.com/consulting/github-copilot-statistics)). Sundar Pichai says 25% of Google’s code is AI-assisted. Satya Nadella has stated that 20–30% of code in Microsoft repositories is AI-generated.

The productivity signal is real. Teams report 55% faster task completion (GitHub + Accenture, 4,800 developers), 30% lower time-to-market ([McKinsey](https://www.mckinsey.com/capabilities/mckinsey-technology/our-insights/measuring-ai-in-software-development-interview-with-jellyfish-ceo-andrew-lau)), and up to 80% lower development cost for early-stage builds (sketchflow.ai).

But the shadow side is equally real. AI-generated code contains 2.74x more security vulnerabilities than human-written code. 45% of OWASP Top 10 security tests fail on AI-generated codebases, and there are 322% more privilege-escalation paths ([softwareseni.com / Veracode](https://softwareseni.com/ai-generated-code-security-risks-why-vulnerabilities-increase-2-74x-and-how-to-prevent-them)). Gartner forecasts that by 2028, 25% of enterprise data breaches will trace to AI agents ([Gartner, October 2025](https://www.gartner.com/en/newsroom/press-releases/2025-10-21-gartner-unveils-top-predictions-for-it-organizations-and-users-in-2026-and-beyond)).

The term “vibe coding” — building software by describing goals in natural language and accepting AI-generated code — was coined by Andrej Karpathy on February 2, 2025 and later became Collins English Dictionary’s Word of the Year ([Wikipedia](https://en.wikipedia.org/wiki/Vibe_coding)). 25% of startups in Y Combinator’s Winter 2025 batch work with 95% AI-generated codebases. Cursor generates $500M ARR with fewer than 30 employees — more than $16 million revenue per person ([nxcode.io](https://nxcode.io/resources/news/what-is-vibe-coding-complete-guide-ai-development-2026)).
...
There are currently 47.2 million developers globally ([SlashData](https://slashdata.co/post/global-developer-population-trends-2025-how-many-developers-are-there)). IDC projects growth to 58.7 million by 2029, but the rate is decelerating from 21% YoY to 10%, and the share of developers aged 18–24 has dropped from 33% to 23% ([IDC](https://my.idc.com/getdoc.jsp?containerId=US53789825)).

Junior developer demand has fallen approximately 40% in companies that have seriously deployed AI tools ([secondtalent.com](https://secondtalent.com/resources/how-ai-is-changing-engineering-talent-demand)). At the same time, AI/ML engineer salaries have risen to $206,000 on average — up $50,000 in a single year. AI skills now command a 56% salary premium ([index.dev](https://index.dev/blog/ai-job-growth-statistics)).

Gartner predicts that by the end of 2026, 75% of developers will spend more time orchestrating and architecting than writing code directly ([Gartner, October 2025](https://www.gartner.com/en/newsroom/press-releases/2025-10-21-gartner-unveils-top-predictions-for-it-organizations-and-users-in-2026-and-beyond)).

New roles are emerging fast: AI Orchestrator, RAG Engineer, AI Guardian, Prompt Engineer. The World Economic Forum estimates that 39% of current technical skills will be obsolete or transformed by 2030 ([WEF 2025](https://www.weforum.org/stories/2025/08/inflection-points-7-global-shifts-defining-2025-so-far-in-charts)).
...
Goldman Sachs notes that AI investment now constitutes 0.8% of US GDP and has produced essentially zero measurable productivity growth at the macro level ([Goldman Sachs](https://www.goldmansachs.com/insights/articles/why-ai-companies-may-invest-more-than-500-billion-in-2026)).
...
Outcome-based pricing already accounts for 43% of new outsourcing contracts in 2025 — the fastest-growing contract type ([Coherent Market Insights](https://coherentmarketinsights.com/industry-reports/it-services-outsourcing-market)).
...
Gartner predicts that by the end of 2026, 75% of developers will orchestrate rather than code ([Gartner, October 2025](https://www.gartner.com/en/newsroom/press-releases/2025-10-21-gartner-unveils-top-predictions-for-it-organizations-and-users-in-2026-and-beyond)).
...
Download the guide and be ready for the next changes in AI.

[Download PDF.](https://5588577.fs1.hubspotusercontent-na1.net/hubfs/5588577/FLS%20Insights%20%E2%80%94%20The%20IT%20Market%20in%202035.pdf)

## Sources

1. [Gartner, February 2026 — IT Spending Forecast](https://www.gartner.com/en/newsroom/press-releases/2026-02-03-gartner-forecasts-worldwide-it-spending-to-grow-10-point-8-percent-in-2026-totaling-6-point-15-trillion-dollars)
...
4. [Gartner, June 2025 — Agentic AI Projects Cancellation Forecast](https://www.gartner.com/en/newsroom/press-releases/2025-06-25-gartner-predicts-over-40-percent-of-agentic-ai-projects-will-be-canceled-by-end-of-2027)
5. [Gartner, October 2025 — Top Predictions for IT Organizations](https://www.gartner.com/en/newsroom/press-releases/2025-10-21-gartner-unveils-top-predictions-for-it-organizations-and-users-in-2026-and-beyond)
6. [Goldman Sachs — AI Investment 2026](https://www.goldmansachs.com/insights/articles/why-ai-companies-may-invest-more-than-500-billion-in-2026)
7. [Crunchbase — Q1 2026 Record VC Funding](https://news.crunchbase.com/venture/record-breaking-funding-ai-global-q1-2026)
8. [Crunchbase — Foundational AI Startup Funding](https://news.crunchbase.com/venture/foundational-ai-startup-funding-doubled-openai-anthropic-xai-q1-2026)
9. [FinancialContent — Q1 2026 M&A Record](https://markets.financialcontent.com/stocks/article/marketminute-2026-4-3-ai-supercycle-propels-q1-2026-m-and-a-to-record-12-trillion-amid-geopolitical-storms)
10. [RBC Wealth Management — Big Tech AI Capex](https://www.rbcwealthmanagement.com/en-us/insights/big-techs-ai-expansion-from-investment-to-scalable-returns)
11. [IDC — Is SaaS Dead?](https://idc.com/resource-center/blog/is-saas-dead-rethinking-the-future-of-software-in-the-age-of-ai)
12. [SaaStr — SaaS Market Crash 2026](https://www.saastr.com/saas-markets-have-crashed-in-2026-but-is-private-credit-the-even-bigger-risk)
13. [Software Equity Group — Annual SaaS Report](https://softwareequity.com/research/annual-saas-report)
14. [Windsor Drake — SaaS Valuation Multiples](https://windsordrake.com/saas-valuation-multiples)
15. [Menlo Ventures — State of Generative AI in the Enterprise 2025](https://menlovc.com/perspective/2025-the-state-of-generative-ai-in-the-enterprise)
16. [Digital Commerce 360 — AI Agents $15T B2B Purchases](https://www.digitalcommerce360.com/2025/11/28/gartner-ai-agents-15-trillion-in-b2b-purchases-by-2028)
17. [Software Strategies Blog — Agentic AI CAGR](https://softwarestrategiesblog.com/2026/02/16/gartner-forecasts-agentic-ai-overtakes-chatbot-spending-2027)
18. [CB Insights — Big Tech AI Growth](https://www.cbinsights.com/research/report/big-tech-ai-future-growth-charts)
19. [SlashData — Global Developer Population 2025](https://slashdata.co/post/global-developer-population-trends-2025-how-many-developers-are-there)
20. [IDC — Developer Forecast 2029](https://my.idc.com/getdoc.jsp?containerId=US53789825)
21. [SecondTalent — AI Impact on Engineering Talent](https://secondtalent.com/resources/how-ai-is-changing-engineering-talent-demand)
22. [Index.dev — AI Job Growth Statistics](https://index.dev/blog/ai-job-growth-statistics)
23. [Quantumrun — GitHub Copilot Statistics](https://quantumrun.com/consulting/github-copilot-statistics)
24. [SoftwareSeni / Veracode — AI Code Security Risks](https://softwareseni.com/ai-generated-code-security-risks-why-vulnerabilities-increase-2-74x-and-how-to-prevent-them)
25. [Wikipedia — Vibe Coding](https://en.wikipedia.org/wiki/Vibe_coding)
26. [NxCode — Vibe Coding Guide 2026](https://nxcode.io/resources/news/what-is-vibe-coding-complete-guide-ai-development-2026)
27. [McKinsey — Measuring AI in Software Development](https://www.mckinsey.com/capabilities/mckinsey-technology/our-insights/measuring-ai-in-software-development-interview-with-jellyfish-ceo-andrew-lau)
28. Sketchflow — AI Development Cost Reduction
29. [CNBC Inside India — AI Impact on Indian IT](https://www.cnbc.com/2026/02/26/cnbc-inside-india-newsletter-ai-hit-software-firms-india-it.html)
30. [Fortune — Big 4 Hiring Cuts](https://fortune.com/2026/01/22/deloitte-job-title-change-ai-reshapes-big-4-accounting-consulting-firms)
31. investing.com — EPAM Earnings Transcript
32. [Coherent Market Insights — IT Services Outsourcing Market](https://coherentmarketinsights.com/industry-reports/it-services-outsourcing-market)
33. [Outsource Accelerator / McKinsey — Automation of US Working Hours](https://news.outsourceaccelerator.com/?p=80615)
34. [WEF 2025 — Technical Skills Obsolescence](https://www.weforum.org/stories/2025/08/inflection-points-7-global-shifts-defining-2025-so-far-in-charts)
35. [Gene Dai / digidai — Cursor vs GitHub Copilot](https://digidai.github.io/2026/03/14/cursor-vs-github-copilot-ai-coding-tools-deep-comparison)